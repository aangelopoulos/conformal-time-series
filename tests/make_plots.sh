...
python inset_plot.py results/elec2.pkl ACI 0.1 Quantile+Integrator\ \(log\)+Scorecaster 0.01 100 1500 'lower right' 50 &
...
python inset_plot.py results/COVID-national-cases-4wk.pkl Quantile+Integrator\ \(log\) 500000 Quantile+Integrator\ \(log\)+Scorecaster 500000 10 60 'upper right' 10 &

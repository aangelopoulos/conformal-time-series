...
python inset_plot.py --filename results/ca-COVID-deaths-4wk.pkl --key1 Quantile --lr1 0 --key2 'Quantile+Integrator (log)+Scorecaster' --lr2 0.1 --window_length 15 --window_start 5 --window_loc 'upper right' --coverage_average_length 10 --miscoverage_scatterplot --set_inset &
